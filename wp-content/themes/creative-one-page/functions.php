...
function creative_one_page_scripts() {
	...
	wp_enqueue_style('creative-one-page-customcss', esc_url(get_template_directory_uri()).'/css/custom.css');
	...
	wp_enqueue_script('creative-one-page-customscripts-jquery', esc_url(get_template_directory_uri()).'/js/custom.js', array('jquery'));
