         ...
         $this->add_control(
              'bsktab_column',
                [
                    ...
                    'default' => '3',
                    'options' => [
                        '1'   => __( '1 Column', 'magical-products-display' ),
                        '2'  => __( '2 Column', 'magical-products-display' ),
                        '3'  => __( '3 Column', 'magical-products-display' ),
                        '4'  => __( '4 Column', 'magical-products-display' ),
                        '6'  => __( '6 Column', 'magical-products-display' ),
                    ]
                ]
            );
        ...
        $this->start_controls_section(
         ...
         $this->add_control(
            ...
            $this->add_control(
              'mgpdeg_rownumber',
                [
                    'label'   => __( 'Show Products Per Row', 'magical-products-display' ),
                    'type'    => \Elementor\Controls_Manager::SELECT,
                    'default' => '4',
                    'options' => [
...
?>
    <div class="col-lg-<?php echo esc_attr($mgpdeg_rownumber); ?>">
