...
/*
	...
	*/
	function frontend_widget_styles(){
		wp_enqueue_style( 'bootstrap',  plugins_url( '/assets/css/bootstrap.min.css', __FILE__ ), array(), '5.1.0', 'all');
//image hover card
...
//main style
		wp_enqueue_style( 'mgproducts-style',  plugins_url( '/assets/css/mpd-display-style.css', __FILE__ ), array(), time(), 'all');
